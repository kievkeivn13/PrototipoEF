...
{
    public partial class frmMantenimientoTipoBodega : Form
    {
        public frmMantenimientoTipoBodega()
        {
            InitializeComponent();
            //TextBox[] alias = { txtID, txtCodigoMarca, txtNombre, txtFecha, txtDescripcion, txtStock, txtPrecio, txtEstatus};
            TextBox[] alias = navegador1.funAsignandoTexts(this);
            navegador1.funAsignarAliasVista(alias, "TipoBodega", "examenfinal");
            ...
            navegador1.pideGrid(this.dtgTipoBodega);
        ...
        {
            navegador1.funSeleccionarDTVista(dtgTipoBodega);
        }

        private void frmMantenimientoTipoBodega_Load(object sender, EventArgs e)
        {
