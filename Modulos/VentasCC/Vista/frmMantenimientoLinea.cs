...
namespace CapaVistaMVentasCC
{
    public partial class frmMantenimientoLinea : Form
    {
        public frmMantenimientoLinea()
        {
            ...
            navegador1.funAsignarAliasVista(alias, "Linea", "examenfinal");
            navegador1.funAsignarSalidadVista(this);
            navegador1.funLlenarComboControl(cbxIdMarca, "TipoIBodega", "Pkid", "Nombre", "Estatus");
            ...
            navegador1.pideGrid(this.dtgLinea);
        ...
        {
            navegador1.funSeleccionarDTVista(dtgLinea);
        }

        private void cbxTipoinventario_SelectedIndexChanged(object sender, EventArgs e)
        {
            navegador1.funComboTextboxVista(cbxIdMarca, txtIdMarca);
        }
    }
}
